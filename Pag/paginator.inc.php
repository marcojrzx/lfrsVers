 ...
 */
 ...
 $variable = new db_mysql;
 $datos=$variable->get_arreglo($_pagi_sql);
 $_pagi_totalReg=count($datos);
...
//********************************************Agregadas por Sambigon*****************************//
 if ($_pagi_actual==-1){
  $_pagi_actual=$_pagi_totalPags;
 }elseif($_pagi_actual==0){
 	$_pagi_actual=1;
 }
//****************************************Fin Agregadas por Sambigon*****************************//
 ...
 */
 ...
 if ($_pagi_actual != 1){
	...
	$_pagi_anterior=$_pagi_enlace."_pagi_pg=".$_pagi_url;
 }
 else{
 	$_pagi_anterior="no hay mas";
 }
 ...
 if ($_pagi_actual < $_pagi_totalPags){
    ...
    $_pagi_siguiente=$_pagi_enlace."_pagi_pg=".$_pagi_url;
 }
 else{
 		$_pagi_siguiente="no hay mas";
 }
 ...
 */
 ...
 $_pagi_result = mysqli_query($GLOBALS['conexion'],$_pagi_sqlLim);
 //Si ocurrió error y mostrar errores está activado
 if($_pagi_result == false && $_pagi_mostrar_errores == true){
 	die ("Error en la consulta limitada. Mysql dijo: <b>".mysqli_error()."</b>");
 }
 ...
 */
 ...
 $_pagi_primera="".$_pagi_enlace."_pagi_pg=1";
 $_pagi_ultimo="".$_pagi_enlace."_pagi_pg=".$_pagi_totalPags;
